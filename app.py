...
st.markdown("<h3 style='color: white; font-size: 15px;'> Bienvenido Estudiante EAFITENSE, este es un espacio de aprendizaje en el cual podrás encontrar información clave dentro de tus Pdf's muy fácil y rápido</h3>", unsafe_allow_html=True)
